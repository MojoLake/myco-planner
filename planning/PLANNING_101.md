...
5. **Configuration examples** help clarify the approach

### What to AVOID in Plans

- ❌ Writing pseudocode or detailed implementation steps
- ❌ Making premature technical decisions that might change
- ❌ Over-specifying UI/UX details before user testing
- ❌ Including exact function signatures unless they're interface contracts
- ❌ Listing every single task that needs to be done (save that for issue tracking)
